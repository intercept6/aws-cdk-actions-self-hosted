...
export const getLinuxOrganizationUserData = ({
  region,
  runnerVersion,
  secretName,
  org,
  ...
  userData.addCommands(
    ...
    `export RUNNER_TOKEN=$(curl -XPOST -fsSL -H "Accept: application/vnd.github.v3+json" -H "Authorization: token $ACCESS_TOKEN" https://api.github.com/orgs/${org}/actions/runners/registration-token | jq -r .token)`,
